    ...
    <form action="todo_create.php" method="POST">
        <fieldset>
            ...
            <div>
                ...
                所属リーグ:<br>
                <input type="radio" name="agreement" value="boys" /> ボーイズ
                <input type="radio" name="agreement" value="young" /> ヤング
                <input type="radio" name="agreement" value="senior" /> シニア
                <input type="radio" name="agreement" value="flesh" /> フレッシュ
                <input type="radio" name="agreement" value="pony" /> ポニー
